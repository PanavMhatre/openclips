...
Generated: 2026-08-13T08:55:30Z
...
NVIDIA/Compute content launched in the final week of this analysis window and is averaging 242 views/post on Instagram — well above the platform average. On TikTok, the v2 classifier reveals Sports Finance (556 avg views) and Crypto (0 avg views) as the top performers, categories that were previously buried in unclassified buckets. The #1 growth lever is platform bifurcation: keep the NVIDIA pipeline for Instagram and YouTube; pivot TikTok production to Sports Finance, Crypto, and Fed/Economy.

---

## Platform Divergence Alert — Do NOT Cross-Post These

- **Sports Finance**: IG #6 (120 avg) vs TikTok #1 (556 avg) — do not cross-post
...
|---|---|---|---|---|---|---|
| Tesla/Elon | 6 | 295 | 11.6 | 0.74% | 7.5s | FM6:spike |
| NVIDIA/Compute | 27 | 242 | 9.4 | 0.90% | 9.7s | FM6:spike |
| General AI | 7 | 133 | 4.8 | 1.18% | 11.8s | — |
| Scaling Laws | 1 | 132 | 4.9 | 0.00% | 9.9s | FM7:underpub |
| OpenAI/Pricing | 1 | 122 | 4.3 | 4.10% | 9.3s | FM7:underpub |
| Sports Finance | 1 | 120 | 4.7 | 0.83% | 8.2s | FM7:underpub |
| DeepSeek/China | 1 | 114 | 4.1 | 0.88% | 8.8s | FM7:underpub |

### TikTok (0 fresh posts excluded)

| Topic | Posts | AvgViews | VpD | AvgER% | Flags |
|---|---|---|---|---|---|
| Sports Finance | 4 | 556 | 139.9 | 0.72% | FM7:underpub |
| General AI | 17 | 76 | 16.6 | 0.61% | FM6:spike |
| Tesla/Elon | 12 | 48 | 8.2 | 0.28% | FM6:spike |
| NVIDIA/Compute | 59 | 47 | 4.8 | 0.35% | FM6:spike |
| DeepSeek/China | 3 | 28 | 3.5 | 0.00% | FM6:spike,FM7:underpub |
| OpenAI/Pricing | 1 | 4 | 0.1 | 0.00% | FM7:underpub |
...
| Topic | Posts | AvgViews | VpD | AvgER% | Flags |
|---|---|---|---|---|---|
| Personal Finance | 1 | 1005 | 15.3 | 0.00% | FM7:underpub |
| Business/Contrarian | 7 | 558 | 9.4 | 0.00% | — |
| Startup Finance | 5 | 318 | 5.5 | 0.00% | — |
| AI Memory | 2 | 252 | 5.0 | 0.00% | FM7:underpub |
| Tesla/Elon | 6 | 191 | 3.0 | 0.00% | FM6:spike |
| Sports Finance | 6 | 174 | 3.1 | 0.00% | FM6:spike |
| Tax/Policy | 5 | 173 | 2.9 | 0.00% | FM6:spike |
| Fed/Economy | 2 | 173 | 3.3 | 0.00% | FM7:underpub |
| General AI | 180 | 156 | 2.5 | 0.00% | FM6:spike |
| OpenAI/Pricing | 18 | 42 | 0.7 | 0.00% | FM6:spike |
| NVIDIA/Compute | 82 | 36 | 0.8 | 0.00% | FM6:spike |
| Scaling Laws | 10 | 19 | 0.4 | 0.00% | FM6:spike |
| AI Hardware | 1 | 10 | 0.2 | 0.00% | FM7:underpub |
| DeepSeek/China | 17 | 6 | 0.3 | 0.00% | FM6:spike |
...
| Why-hook | 8 | 224 | 0.51% | 10.3s | ER/comments/shares |
| Other-hook | 27 | 222 | 1.04% | 9.9s | Varies |
| The/Number-hook | 7 | 120 | 0.97% | 8.0s | Watch time/saves |

---

## Timing

- **Optimal window: 20:00–21:00 UTC** — 312 avg views vs 273 off-peak (1.1× multiplier)
...
- **Sports Finance**: 4 posts, 556 avg views — test 5–8 more to confirm
